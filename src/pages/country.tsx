...
const Country = ({}: Props) => {
  ...
  return (
    <div className="w-full  min-h-screen font-worksans flex flex-col justify-center items-center  text-white">
      <div className="w-5/6 p-12 min-h-screen  bg-slate-800 md:flex rounded-md gap-4 mt-32 ">
      <div >
